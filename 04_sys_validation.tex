...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figures/e2ap_capture}
...
This scenario aims at evaluating the accuracy of the messages generated.
...
\subsection{Scenario 3: Moving gNB}\label{subsec:scenario-1:-moving-gnb}
% change it
In this scenario, the UE encounters an obstacle that obstructs its LoS. % change specially this sentance
