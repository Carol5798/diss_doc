...
\begin{figure}
    \centering
    \includegraphics{figures/urban_scenario}
    \caption[mmWave base station equipped with camera to monitor and prevent LoS obstruction to users]{mmWave base station equipped with camera to monitor and prevent LoS obstruction to users \cite{Block_predict}.}
    \label{fig:urban_scenario}
\end{figure}
\textcolor{red}{Increase resolution}
